...
public class TheaterTicketsTest {
    ...
    void testCalculateTicketPrice_EdgeCases() {
        ...
        assertThat(TheaterTickets.calculateTicketPrice(18, true, false)).isCloseTo(500.0, offset(DELTA)); // 18, студ, будни -> 25%
        assertThat(TheaterTickets.calculateTicketPrice(18, false, false)).isCloseTo(500.0, offset(DELTA)); // 18, не студ -> 50%
